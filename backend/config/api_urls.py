...
urlpatterns = [
    ...
    # ── Admin CRUD API (pymongo-powered, bypasses Djongo) ──────────────────
    ...
    path('admin/payments/',           admin_views.AdminPaymentsView.as_view()),
    path('admin/notifications/',      admin_views.AdminNotificationsView.as_view()),
